...
export default function FibuCompleteDashboard() {
  ...
  const [activeTab, setActiveTab] = useState('umsaetze') // Start with Umsätze (schneller als Overview)
  ...
  if (activeTab === 'uebersicht' && (!data || !data.ok)) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* 6. Zuordnung (Manuelle Zuordnung / Unzugeordnete Items) */}
        {activeTab === 'zuordnung' && (
