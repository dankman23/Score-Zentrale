    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if all_passed:
                ...
                print(f"Sample data - JTL Revenue: {data['jtl']['totals']['revenue']}")
                print(f"Sample data - GA4 Users: {data['ga4']['totals']['users']}")
                print(f"Sample data - Ads Campaigns count: {len(data['ads']['campaigns'])}")
                return True
            else:
...
def test_prospects_flow():
    """Test POST and GET /api/prospects endpoints"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if all_present:
                ...
                print(f"Sample productGroups: {result['productGroups'][:2] if len(result['productGroups']) > 1 else result['productGroups']}")
                print(f"Sample materials: {result['materials']}")
                return True
            else:
...
def test_status_endpoints():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'id' in result and 'client_name' in result and result['client_name'] == 'qa':
