...
**Download:** `https://staffel-price.preview.emergentagent.com/api/fibu/debug/export-jtl-raw?from=2025-10-01&to=2025-10-31&format=csv`
...
### Produktiv-Umgebung:
**URL:** `https://staffel-price.preview.emergentagent.com`  
...
curl -X POST "https://staffel-price.preview.emergentagent.com/api/fibu/import/amazon-jtl?from=2025-11-01&to=2025-11-30&force=true"
```
