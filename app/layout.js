  ...
  return (
    <html lang="de">
      <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css?v=fix2" />
        {/* Bootstrap Icons */}
                ...
                <ul className="nav nav-pills subnav-icons" style={{margin: 0, padding: '5px 0', flexWrap: 'nowrap', gap: '4px'}}>
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu">
                      ...
                      <a className="dropdown-item" href="/#artikelrating"><i className="bi bi-star mr-1"/>Artikelrating</a>
