        ...
        <nav className="navbar navbar-expand-lg navbar-dark sticky-top">
          ...
          <div className="collapse navbar-collapse" id="navMain">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item"><a className="nav-link" href="#akquise"><i className="bi bi-people mr-1"/>Akquise</a></li>
            ...
            <div className="container py-2">
              ...
              <div className="hero-shield p-0">
                <ul className="nav nav-pills subnav-icons">
                  ...
                  <li className="nav-item"><a className="nav-link" href="#akquise"><i className="bi bi-people"/>Akquise</a></li>
        ...
        <div className="app-tabbar d-lg-none">
          <div className="container-fluid px-0">
            <ul className="nav nav-pills nav-justified">
              ...
              <li className="nav-item"><a className="nav-link" href="#coldleads"><i className="bi bi-search d-block"/><small>Kaltakquise</small></a></li>
              <li className="nav-item"><a className="nav-link" href="#outbound"><i className="bi bi-send d-block"/><small>Outbound</small></a></li>
            </ul>
          </div>
        </div>
