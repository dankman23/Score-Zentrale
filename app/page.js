...
export default function App() {
  ...
  useEffect(() => {
    const applyHash = () => { const h=(window.location.hash||'#dashboard').replace('#',''); if (['dashboard','sales','marketing','glossar','kaltakquise','warmakquise','outbound','produkte'].includes(h)) setActiveTab(h) }
